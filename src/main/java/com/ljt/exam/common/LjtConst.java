package com.ljt.exam.common;

public class LjtConst {

    //session
    public final static String CURRET_ACCOUNT= "current_account";

    //本地服务器-文件，图片所在位置的上传
    public static final String UPLOAD_FILE_PATH = "file:E:/springboot-penguin/upload/";
    public static final String UPLOAD_FILE_IMAGE_PATH = "E:/springboot-penguin/upload//images/";
